  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex border-b">
        <button
          className={`flex-1 py-2 px-4 text-center font-medium ${inputMode === 'text'
        ...
        <button
          className={`flex-1 py-2 px-4 text-center font-medium ${inputMode === 'audio'
            ? 'border-b-2 border-blue-500 text-blue-600'
            : 'text-gray-500 hover:text-gray-700'
            }`}
      ...
      {inputMode === 'text' && (
        <form onSubmit={handleTextSubmit} className="space-y-4">
          <div>
            <label htmlFor="session-text" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Digite o texto da sessão
            </label>
            <textarea
              id="session-text"
              rows={8}
              className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 dark:text-white transition-colors"
