  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 mb-8">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <dt className="text-sm font-medium text-gray-500 truncate">Sessões Realizadas</dt>
            <dd className="mt-1 text-3xl font-semibold text-gray-900">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Evolução Mensal (Em Breve)</h3>
        <div className="h-64 bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
          <span className="text-gray-500">Gráficos de tendências serão exibidos aqui</span>
        </div>
      </div>
    </div>
  )
